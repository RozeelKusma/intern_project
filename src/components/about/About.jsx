...
const About = () => {
  return (
    ...
    <div className='main_about'>
      <div className="top_a_div">
        <img src="https://www.alliancetrust.co.uk/static/img/dev/about-hero.jpg" alt="about Us" className="top_img" />
